...
public static class WastelandForgeSchemaCatalog
{
    ...
    [
        ...
        new(WastelandForgeSchemaIds.GeckAuthoringIntent020, "geck-authoring-intent", "0.2.0", "schemas/geck-authoring-intent/0.2.0/schema.json"),
        new(WastelandForgeSchemaIds.GeckAuthoringPlan010, "geck-authoring-plan", "0.1.0", "schemas/geck-authoring-plan/0.1.0/schema.json"),
        new(WastelandForgeSchemaIds.GeckAuthoringPlan020, "geck-authoring-plan", "0.2.0", "schemas/geck-authoring-plan/0.2.0/schema.json"),
        new(WastelandForgeSchemaIds.GeckAuthoringSubjectHandoff010, "geck-authoring-subject-handoff", "0.1.0", "schemas/geck-authoring-subject-handoff/0.1.0/schema.json"),
        new(WastelandForgeSchemaIds.GeckAuthoringSubjectHandoff020, "geck-authoring-subject-handoff", "0.2.0", "schemas/geck-authoring-subject-handoff/0.2.0/schema.json"),
        new(WastelandForgeSchemaIds.GeckPlacementEvidence010, "geck-placement-evidence", "0.1.0", "schemas/geck-placement-evidence/0.1.0/schema.json"),
        new(WastelandForgeSchemaIds.GeckAuthoringObservations010, "geck-authoring-observations", "0.1.0", "schemas/geck-authoring-observations/0.1.0/schema.json"),
        ...
        new(WastelandForgeSchemaIds.FnvGameKnowledgeExecutionPlan020, "fnv-game-knowledge-execution-plan", "0.2.0", "schemas/fnv-game-knowledge-execution-plan/0.2.0/schema.json"),
        new(WastelandForgeSchemaIds.FnvGameKnowledgeExecutionReceipt020, "fnv-game-knowledge-execution-receipt", "0.2.0", "schemas/fnv-game-knowledge-execution-receipt/0.2.0/schema.json"),
