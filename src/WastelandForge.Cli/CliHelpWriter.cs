...
internal static class CliHelpWriter
{
    ...
    private static void WriteGenerateHelp(TextWriter writer)
    {
        ...
        writer.WriteLine();
        writer.WriteLine("Usage:");
        writer.WriteLine("  forge generate [project-root] [--project <path>] [--target reports|mcm-json|jip-scripts|xedit-audit|xedit-audit-report-handoff|geck-authoring-plan|geck-authoring-verifier|geck-authoring-verification] [--observations <project-relative-path>] [--output generated/<name>] [--format human|plain|json] [--dry-run] [--no-input]");
        writer.WriteLine();
