...
internal static class CliHelpWriter
{
    ...
    private static void WritePackageHelp(TextWriter writer)
    {
        ...
        writer.WriteLine();
        writer.WriteLine("Usage:");
        writer.WriteLine("  forge package [project-root] [--project <path>] [--target reports|mcm-json|jip-scripts|mod-package|geck-handoff|fomod] [--output dist/<name>] [--mo2-mods-root <path> --mo2-mod-name <name>] [--reuse-existing-package] [--summary <path>] [--format human|plain|json|sarif|github] [--dry-run] [--verify-existing] [--no-input]");
        writer.WriteLine();
        ...
        writer.WriteLine("Target 'geck-handoff' writes deterministic quest, dialogue, voice, and optional JIP authoring worklists plus provenance. It does not create plugin records, compile scripts, mutate plugins, or launch GECK/xEdit.");
