...
internal static class ExplainOutputCatalog
{
    ...
    [
        ...
        Pattern("dist/build/build-plan.json", "reports", "build-plan", "dist", "forge build --target reports", "Recorded in dist/build/build-manifest.json.", ["WF-BUILD-001"]),
        Pattern("dist/build/build-plan.md", "reports", "build-plan-markdown", "dist", "forge build --target reports", "Recorded in dist/build/build-manifest.json.", ["WF-BUILD-001"]),
        ...
        Pattern("dist/build/build-report-index.json", "reports", "build-report-index", "dist", "forge build --target reports", "Recorded in dist/build/build-manifest.json.", ["WF-BUILD-001"]),
        Pattern("dist/build/build-report-index.md", "reports", "build-report-index-markdown", "dist", "forge build --target reports", "Recorded in dist/build/build-manifest.json.", ["WF-BUILD-001"]),
        ...
        Pattern("dist/reports-package/package.zip", "reports", "package-archive", "dist", "forge package --target reports", "Recorded in dist/reports-package/build-manifest.json and checksums.sha256.", ["WF-BUILD-001"]),
        Pattern("dist/reports-package/package-archive-evidence.json", "reports", "package-archive-evidence", "dist", "forge package --target reports", "Recorded in dist/reports-package/build-manifest.json and checksums.sha256.", ["WF-BUILD-001"]),
        ...
        Pattern("generated/geck-authoring-plan/plan.json", "geck-authoring-plan", "geck-authoring-plan", "generated", "forge generate --target geck-authoring-plan", "Digest-bound preview-only authoring plan; version 0.2.0 carries exact operator-attested placement lineage and is never an execution receipt.", ["WF-GEN-016"]),
        Pattern("generated/geck-authoring-plan/build-manifest.json", "geck-authoring-plan", "build-manifest", "generated", "forge generate --target geck-authoring-plan", "Records source and plan digest with all execution flags disabled.", ["WF-GEN-016"]),
        Pattern("generated/geck-authoring-plan/checksums.sha256", "geck-authoring-plan", "checksum-sidecar", "generated", "forge generate --target geck-authoring-plan", "Checksum evidence for preview-only plan outputs.", ["WF-GEN-016"]),
        Pattern("generated/geck-authoring-plan/subject-handoff/subject-contract.json", "geck-authoring-subject-handoff", "geck-authoring-subject-contract", "generated", "forge generate --target geck-authoring-subject-handoff", "Digest-bound manual authoring contract; not a plugin, execution receipt, verification, approval, or license.", ["WF-GEN-019"]),
        Pattern("generated/geck-authoring-plan/subject-handoff/worklist.md", "geck-authoring-subject-handoff", "manual-geck-authoring-worklist", "generated", "forge generate --target geck-authoring-subject-handoff", "Human-readable projection of the exact resolved plan; checklist state is not canonical evidence.", ["WF-GEN-019"]),
        Pattern("generated/geck-authoring-plan/subject-handoff/creation-notes.template.md", "geck-authoring-subject-handoff", "creation-notes-template", "generated", "forge generate --target geck-authoring-subject-handoff", "Incomplete template that must be completed externally by the fixture author.", ["WF-GEN-019"]),
        Pattern("generated/geck-authoring-plan/subject-handoff/build-manifest.json", "geck-authoring-subject-handoff", "build-manifest", "generated", "forge generate --target geck-authoring-subject-handoff", "Records exact plan/source and generated-kit provenance with all consequential effects disabled.", ["WF-GEN-019"]),
        Pattern("generated/geck-authoring-plan/subject-handoff/checksums.sha256", "geck-authoring-subject-handoff", "checksum-sidecar", "generated", "forge generate --target geck-authoring-subject-handoff", "Checksum evidence for the deterministic manual authoring kit.", ["WF-GEN-019"]),
        Pattern("generated/geck-authoring-plan/verification/verifier.pas", "geck-authoring-verifier", "xedit-read-only-observer", "generated", "forge generate --target geck-authoring-verifier", "Deterministic first-slice Pascal observer source; Forge does not execute it.", ["WF-GEN-017"]),
        Pattern("generated/geck-authoring-plan/verification/observer-contract.json", "geck-authoring-verifier", "observer-contract", "generated", "forge generate --target geck-authoring-verifier", "Digest-bound contract consumed by the generated observer.", ["WF-GEN-017"]),
        Pattern("generated/geck-authoring-plan/verification/observer-manifest.json", "geck-authoring-verifier", "observer-manifest", "generated", "forge generate --target geck-authoring-verifier", "Records the exact plan, provider evidence, and observer artifacts.", ["WF-GEN-017"]),
        Pattern("generated/geck-authoring-plan/verification/checksums.sha256", "geck-authoring-verifier", "checksum-sidecar", "generated", "forge generate --target geck-authoring-verifier", "Checksum evidence for the deterministic observer bundle.", ["WF-GEN-017"]),
        Pattern("generated/geck-authoring-plan/verification/report.json", "geck-authoring-verification", "geck-authoring-verification-report", "generated", "forge generate --target geck-authoring-verification --observations <path>", "Forge-sealed Gate 522 report produced from immutable raw observations and rechecked semantically.", ["WF-GEN-017", "WF-SEM-046"]),
        ...
        Pattern("dist/release-dry-run/release-verify.json", "release-verify", "release-verification-self-report", "dist", "forge release verify", "Recorded in dist/release-dry-run/build-manifest.json and checksums.sha256.", ["WF-REL-001"]),
        Pattern("dist/release-dry-run/release-evidence-index.json", "release-verify", "release-evidence-index", "dist", "forge release verify", "Indexes expected release-publish preflight evidence paths and command hints; recorded in dist/release-dry-run/build-manifest.json and checksums.sha256.", ["WF-REL-001"]),
        Pattern("dist/release-dry-run/release-evidence-status.json", "release-verify", "release-evidence-status", "dist", "forge release verify", "Projects indexed release-publish preflight evidence paths as present or missing; recorded in dist/release-dry-run/build-manifest.json and checksums.sha256.", ["WF-REL-001"]),
        Pattern("dist/release-dry-run/release-evidence-actions.json", "release-verify", "release-evidence-actions", "dist", "forge release verify", "Lists manual action hints for missing release-publish preflight evidence; recorded in dist/release-dry-run/build-manifest.json and checksums.sha256.", ["WF-REL-001"]),
        Pattern("dist/release-dry-run/release-evidence-collection-plan.json", "release-verify", "release-evidence-collection-plan", "dist", "forge release verify", "Lists ordered local evidence collection steps without executing command hints; recorded in dist/release-dry-run/build-manifest.json and checksums.sha256.", ["WF-REL-001"]),
        Pattern("dist/release-dry-run/release-evidence-handoff.md", "release-verify", "release-evidence-handoff", "dist", "forge release verify", "Markdown handoff summary rendered from release-evidence-index.json for operators; recorded in dist/release-dry-run/build-manifest.json and checksums.sha256.", ["WF-REL-001"]),
