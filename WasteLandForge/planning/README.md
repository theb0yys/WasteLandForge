...
- Gate 484 - implement the optional MO2 launch-request and companion-plugin vertical slice with desktop request generation, strict Python validation, explicit profile preview, fake-organizer/handle tests, receipt evidence, publication, and installed request-generation proof without live MO2 execution.
