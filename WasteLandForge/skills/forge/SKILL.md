...
| `/forge release verify` | release gates, local self-report evidence, manifests, checksums, and governance through validation release governance prompts |
...
wiring, `forge build` target wiring, package staging, runtime probe, GECK
automation, MO2 VFS inspection, live Data mutation, external tool execution,
command alias, new CLI output format, or AI behavior. Route the next
implementation slice to Gate 208: non-emitting JIP text-script generation
planning skeleton.

Gate 208 option routing:
...
Data mutation, external tool execution, command alias, new CLI output format,
or AI behavior. Route the next implementation slice to Gate 209: in-memory
JIP text-script renderer skeleton.

Gate 209 option routing:
...
MO2 VFS inspection, live Data mutation, external tool execution, command
alias, new CLI output format, or AI behavior. Route the next implementation
slice to Gate 210: generated-file emission under `generated/jip-scripts`
only.

Gate 210 option routing:
...
external tool execution, command alias, new CLI output format, or AI behavior.
Route the next implementation slice to Gate 211: generated JIP emission
manifest and digest skeleton.

Gate 211 option routing:
...
mutation, external tool execution, command alias, new CLI output format, or AI
behavior. Route the next implementation slice to Gate 212: generated JIP
emission manifest schema and validation skeleton.

Gate 212 option routing:
...
package staging, runtime probe, GECK automation, MO2 VFS inspection, live Data
mutation, external tool execution, command alias, new CLI output format, or AI
behavior. Route the next implementation slice to Gate 213: JIP emission
checksum sidecar revalidation skeleton.

Gate 213 option routing:
...
implements explicit `forge clean --dist` execution, and Gate 255 implements
  ...
  development step to Gate 461: implement and verify the end-to-end desktop
  Release Candidate workspace defined by Gate 460, including published and
  installed regression coverage.
