...
- Gate 547 - implement and synthetic/installed prove the private single-master FNVEdit execution bundle, automated `0.2.0` evidence lineage, digest-approved process runner, visible readiness, and strict side-effect audit, then stop before a separately approved real-provider retry.
