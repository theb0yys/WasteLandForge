...
- Gate 332 - scaffold repository-owned developer task local-tool bootstrap through `.vscode/tasks.json`, still stopping before generated workflow/task mutation, NuGet publication, provider installation, external tool execution, MO2 automation, GECK automation, runtime probes, real third-party plugin fixtures, release publication, remote repository calls, signing or attestation, plugin mutation, VS Code extension generation, language-server process startup, or AI behavior.
