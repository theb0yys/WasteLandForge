...
public sealed class SchemaBackCompatTests
{
    ...
    [InlineData(WastelandForgeSchemaIds.GeckAuthoringSubjectHandoff010, "geck-authoring-subject-handoff", "0.1.0")]
    [InlineData(WastelandForgeSchemaIds.GeckAuthoringIntent010, "geck-authoring-intent", "0.1.0")]
    [InlineData(WastelandForgeSchemaIds.GeckAuthoringIntent020, "geck-authoring-intent", "0.2.0")]
    [InlineData(WastelandForgeSchemaIds.GeckAuthoringPlan010, "geck-authoring-plan", "0.1.0")]
    [InlineData(WastelandForgeSchemaIds.GeckAuthoringPlan020, "geck-authoring-plan", "0.2.0")]
    [InlineData(WastelandForgeSchemaIds.GeckAuthoringSubjectHandoff020, "geck-authoring-subject-handoff", "0.2.0")]
    [InlineData(WastelandForgeSchemaIds.GeckPlacementEvidence010, "geck-placement-evidence", "0.1.0")]
    ...
    [InlineData(WastelandForgeSchemaIds.FnvGameKnowledgeExecutionPlan020, "fnv-game-knowledge-execution-plan", "0.2.0")]
    [InlineData(WastelandForgeSchemaIds.FnvGameKnowledgeExecutionReceipt020, "fnv-game-knowledge-execution-receipt", "0.2.0")]
