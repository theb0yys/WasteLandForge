...
- Gate 544 - implement the synthetic/local-cache Game Knowledge vertical slice, immutable evidence schemas, deterministic read-only xEdit export bundle, strict import/index/search, provenance receipts, provisional GECK Intent Builder handoff, publication, installer, and installed regression without running real xEdit or copying Bethesda data into the repository.
