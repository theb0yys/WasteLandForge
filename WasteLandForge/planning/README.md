...
- Gate 336 - close the generated consumer-project Forge command availability guidance lane and route to the next value slice, still stopping before generated local tool manifest emission, root `NuGet.config`, NuGet publication, package restore, external tool execution, runtime probes, signing or attestation, and AI behavior.
