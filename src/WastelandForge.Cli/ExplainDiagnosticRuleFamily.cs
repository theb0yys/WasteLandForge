...
internal static class ExplainDiagnosticRuleFamilies
{
    ...
    private static readonly IReadOnlyDictionary<string, ExplainDiagnosticRuleDetail> RuleDetails =
        new Dictionary<string, ExplainDiagnosticRuleDetail>(StringComparer.Ordinal)
        {
            ...
            ["WF-GEN-016"] = Detail("WF-GEN-016", "GECK authoring plan unresolved", "Canonical authoring intent, local resolutions, provider evidence, or generated plan validation is incomplete or stale.", "docs/governance/rule-families.md#gate-521"),
            ...
            ["WF-GEN-019"] = Detail("WF-GEN-019", "GECK verifier subject handoff invalid", "The manual subject handoff cannot be generated because its plan, evidence, first-slice semantics, source-plugin state, safety policy, or existing generated bundle is missing, stale, unsafe, or incompatible.", "docs/governance/rule-families.md#gate-556"),
