...
internal static class ExplainDiagnosticRuleFamilies
{
    ...
    private static readonly IReadOnlyDictionary<string, ExplainDiagnosticRuleDetail> RuleDetails =
        new Dictionary<string, ExplainDiagnosticRuleDetail>(StringComparer.Ordinal)
        {
            ...
            ["WF-GEN-015"] = Detail("WF-GEN-015", "xEdit Check report evidence invalid", "An xEdit Check report is malformed, unsafe, stale, duplicated, or does not match the current generated script and plugin artifact.", "docs/governance/rule-families.md#gate-502"),
            ["WF-GEN-016"] = Detail("WF-GEN-016", "GECK authoring plan unresolved", "Canonical authoring intent, local resolutions, provider evidence, operator-attested placement lineage, or generated plan validation is incomplete, stale, or mismatched.", "docs/governance/rule-families.md#gate-521"),
            ["WF-GEN-017"] = Detail("WF-GEN-017", "GECK authoring verifier evidence invalid", "The observer bundle or raw observations are missing, malformed, incomplete, unsafe, stale, digest-mismatched, or unsupported by the first-slice verifier.", "docs/governance/rule-families.md#gate-533"),
            ["WF-GEN-018"] = Detail("WF-GEN-018", "FNV game-knowledge evidence invalid", "The private local export, generated script, sealed index, provenance, or receipt is malformed, incomplete, unsafe, stale, path-unsafe, oversized, duplicated, or digest-mismatched.", "docs/governance/rule-families.md#gate-544"),
            ["WF-GEN-019"] = Detail("WF-GEN-019", "GECK verifier subject handoff invalid", "The manual subject handoff cannot be generated because plan 0.2.0, placement lineage, first-slice semantics, source-plugin state, safety policy, or the generated bundle is missing, stale, unsafe, or incompatible.", "docs/governance/rule-families.md#gate-556"),
            ["WF-SEM-045"] = Detail("WF-SEM-045", "xEdit Check found a record error", "The manually run xEdit Check API returned a non-empty error for the identified plugin record.", "docs/governance/rule-families.md#gate-502"),
            ["WF-SEM-046"] = Detail("WF-SEM-046", "GECK authoring semantic verification failed", "A read-only xEdit semantic report is invalid, stale, or does not match the exact GECK authoring plan postconditions.", "docs/governance/rule-families.md#gate-522"),
