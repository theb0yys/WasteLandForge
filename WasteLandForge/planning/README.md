...
- Gate 529 - implement the private host-probe run-plan schema/parser, authorized-build and create-only staging previews, protected-manifest capture, and synthetic read-only MO2 effective-provider preflight; remain no-launch and refuse executable output while real instance/profile/provider evidence is unresolved.
